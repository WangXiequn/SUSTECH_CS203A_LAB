...
public class Main {
    public static long predecessorQuery(AVLTree tree,long q){
    ...
    public static long SuccessorQuery(AVLTree tree,long q){
        long p = Integer.MIN_VALUE;
        AVLTree u = tree;
        while (u!=null){
            if (u.key==q) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (cases==0){
                if (adopter.arr[0]==0){
                    ...
                    long predecessor = predecessorQuery(adopter,value);
                    long successor = SuccessorQuery(adopter,value);
                    if (Math.abs(predecessor-value)<=Math.abs(successor-value)){
                        answer+=Math.abs(predecessor-value);
                        AVLTree.deletion(adopter,(int)predecessor);
                    }else {
                        answer+=Math.abs(successor-value);
                        AVLTree.deletion(adopter,(int)successor);
                    }
                }
            }else {
                if (pet.arr[0]==0){
                    ...
                    long predecessor = predecessorQuery(pet,value);
                    long successor = SuccessorQuery(pet,value);
                    if (Math.abs(predecessor-value)<=Math.abs(successor-value)){
                        answer+=Math.abs(predecessor-value);
                        AVLTree.deletion(pet,(int)predecessor);
                    }else {
                        answer+=Math.abs(successor-value);
                        AVLTree.deletion(pet,(int)successor);
                    }
                }
            }
